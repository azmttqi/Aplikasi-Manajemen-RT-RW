...
class _ProfileScreenState extends State<ProfileScreen> {
    ...
    if (mounted) {
      if (result != null) {
        setState(() {
          ...
          _email = result['email'] ?? "-";
          _role = result['role'] ?? "RW"; // Default RW/RT
  ...
  // 3. Fungsi Dialog Update (Logic Tetap Sama)
                ...
                ElevatedButton(
                  onPressed: isSubmitting ? null : () async {
                    if (currentPassController.text.isEmpty || newValueController.text.isEmpty) {
                      ScaffoldMessenger.of(context).showSnackBar(const SnackBar(content: Text("Mohon isi semua kolom")));
                      return;
                    }
                  ...
                  child: isSubmitting ? const CircularProgressIndicator(color: Colors.white) : const Text("Simpan", style: TextStyle(color: Colors.white)),
                ),
              ],
            );
          },
          ...
          child: Column(
            children: [
                ...
                children: [
                  ...
                  Positioned(
                    ...
                    child: Container(
                      ...
                      child: const Icon(Icons.star, color: Colors.white, size: 18), // Icon Bintang utk Admin/RW
                    ),
                  )
                ],
              ),
              ...
              Container(
                 ...
                 child: Text("Pengurus $_role $_wilayah", style: TextStyle(color: Colors.green[800], fontWeight: FontWeight.bold, fontSize: 12)),
              ),
              ...
              Container(
                ...
                child: Column(
                  children: [
                    _buildInfoRow(Icons.location_on, "Wilayah Admin", "RW $_wilayah"),
                    const Divider(),
