        ...
        return Container(
          ...
          child: Column(
            ...
            children: [
              ...
              const Text("Statistik Gender", style: TextStyle(fontSize: 20, fontWeight: FontWeight.bold)),
    ...
    return Container(
      ...
      child: Row(
        ...
        children: [
          ...
          Text("$count Jiwa", style: const TextStyle(fontSize: 18, fontWeight: FontWeight.bold, color: Colors.black87)),
        ],
      ),
    );
  }

  // Popup Detail KK (Status Rumah)
  void _showKkDetail(BuildContext context) {
    // Data simulasi (nanti bisa diganti dengan data real API jika ada)
        ...
        return Container(
          ...
          child: Column(
            ...
            children: [
              ...
              const Text("Status Tempat Tinggal", style: TextStyle(fontSize: 20, fontWeight: FontWeight.bold)),
              const SizedBox(height: 25),
